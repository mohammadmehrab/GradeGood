...
export default function GradeInputPage() {
  ...
  const [schedule, setSchedule] = useState([
    { day: [] as string[], startTime: "", endTime: "" },
  ]);
        ...
        <div className={styles.input_contain}>
          ...
          <div className={styles.input_field}>
            ...
            <input
              ...
              value={creditHours}
              onChange={(event) =>
                setCreditHours(parseFloat(event.target.value))
              }
            />
          </div>
          <div className={styles.input_field}>
      ...
      <div>
        {courseDetails.map((c, i) => (
          <details key={i} className={styles.details}>
            ...
            <p>Grade: {c.grade}</p>
            <p>
              Schedule Details: {c.schedule[0].day.join(",")} from{" "}
              {c.schedule[0].startTime} to {c.schedule[0].endTime}
            </p>
            <button
