...
export default function ProgChart({pols}: ProgChartItems) {
    ...
    const lineColors = ["red","blue","yellow","green","orange","purple","pink"];
            ...
            <ResponsiveContainer width="100%" height={300}>
                <LineChart data={data}>
                    ...
                    <XAxis dataKey="name" label= {{
                        value: "Element index", position: "insideBottom", offset: -5
                    }}
                        tickFormatter={(value) => `${value}`}
                    />
                    <YAxis domain={[0, 100]} label= {{
                        value: "Grade", position: "insideLeft", angle: -90
                    }}/>
                    
                    <Legend/>
                    <Tooltip/>
                    <Line type="linear" dataKey="Target Grade" stroke="#3b82f6" strokeWidth={2} activeDot={{r: 6}}/>
